      ...
      <div className="container-custom flex h-16 items-center">
        ...
        <Link href="/" className="flex items-center space-x-2 mr-8">
          ...
          >
            ...
            <path d="M60.8606 35.9187V10.9905H70.6956C72.5863 10.9905 74.1971 11.3516 75.5279 12.0738C76.8587 12.7878 77.873 13.7819 78.5708 15.0559C79.2768 16.3218 79.6298 17.7824 79.6298 19.4378C79.6298 21.0932 79.2728 22.5538 78.5587 23.8197C77.8446 25.0856 76.81 26.0715 75.4548 26.7775C74.1078 27.4835 72.4767 27.8365 70.5617 27.8365H64.2931V23.6128H69.7096C70.724 23.6128 71.5598 23.4383 72.2171 23.0894C72.8825 22.7324 73.775 22.2414 73.7021 21.6166C74.0348 20.9836 74.2011 20.2574 74.2011 19.4378C74.2011 18.6101 74.0348 17.8879 73.7021 17.2712C73.3775 16.6464 72.8825 16.1635 72.2171 15.8227C71.5517 15.4738 70.7077 15.2993 69.6853 15.2993H66.1311V35.9187H60.8606Z" fill="#265DF5"/>
            <path d="M5.45445 10.3289C8.73925 2.47107 17.7721 -1.2361 25.63 2.0487L39.8325 7.98577C45.1215 10.1967 47.6167 16.2766 45.4058 21.5656L43.6863 25.6788C38.0722 39.1088 22.6339 45.4448 9.20385 39.8307C1.64322 36.6701 -1.92375 27.9789 1.23682 20.4182L5.45445 10.3289Z" fill="url(#paint0_linear_1401_3788)"/>
            <path d="M11.6564 37.8237L5.05494 29.1929L29.6129 10.4088L36.2144 19.0396L11.6564 37.8237Z" fill="url(#paint1_linear_1401_3788)"/>
            <defs>
              <linearGradient id="paint0_linear_1401_3788" x1="73.7998" y1="0.851562" x2="65.8294" y2="49.969" gradientUnits="userSpaceOnUse">
                <stop offset="1" stopColor="#265DF5"/>
              </linearGradient>
              <linearGradient id="paint1_linear_1401_3788" x1="27.0577" y1="17.1298" x2="0.220227" y2="32.2398" gradientUnits="userSpaceOnUse">
