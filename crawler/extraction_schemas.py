...
job_detail_extraction_schema = {
    ...
    "fields": [
        ...
        {"name": "company_website", "selector": "li:has(strong:contains('Site Internet')) a", "type": "attribute", "attribute": "href"},
        ...
        {"name": "valid_through", "selector": "li:has(strong:contains('Date limite')) span", "type": "text"},
        ...
        {"name": "salary", "selector": "li:has(strong:contains('Salaire')) span", "type": "text"},
        {"name": "languages", "selector": "li:has(strong:contains('Langues exigées')) span", "type": "text-list"},
        {"name": "number_of_positions", "selector": "li:has(strong:contains('Nombre de poste')) span", "type": "text"},
        ...
        {"name": "sector", "selector": "li:has(strong:contains('Secteur d´activité')) span", "type": "text-list"},
        {"name": "job_type", "selector": "li:has(strong:contains('Métier')) span", "type": "text-list"},
        {"name": "tags", "selector": "ul.skills li", "type": "text-list"},
        {"name": "contact_email", "selector": "li:has(strong:contains('Email')) span", "type": "text"},
        {"name": "other_benefits", "selector": ".page-application-content em.text-md", "type": "text"},
        # Champs additionnels potentiels
        {"name": "contact_phone", "selector": "li:has(strong:contains('Téléphone')) span", "type": "text"},
        {"name": "date_limite", "selector": "li:has(strong:contains('Date limite')) span", "type": "text"},
        {"name": "reference", "selector": "li:has(strong:contains('Référence')) span", "type": "text"},
